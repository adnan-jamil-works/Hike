...
const Section01 = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col md:flex-row items-center justify-between overflow-hidden px-8 sm:px-16 lg:px-24  mt-0 lg:mt-80">
      {/* Big faded number */}
      <span className="absolute top-10 left-8 text-[6rem] sm:text-[10rem] font-bold text-white opacity-10 select-none">
        01
      </span>
      ...
      {/* Right image */}
      <div className="relative rounded-lg flex-1 mt-10 md:mt-0 w-full md:w-1/2 h-[500px] md:h-[600px] overflow-hidden">
        <img
          src={pic4}
